...
const URL = `${SITE}/loyer-fixe-airbnb-casablanca`;
...
const FAQS = [
  {
    q: "Comment est calculé mon loyer fixe garanti à Casablanca ?",
    a: "On audite votre bien (localisation, taille, équipement, photos), on regarde le marché local sur 12 mois (saisonnalité business, taux d'occupation moyen, ADR), et on vous propose un loyer fixe représentant environ 65 à 75% du revenu net potentiel. La différence couvre notre risque commercial et nos coûts opérationnels.",
  },
  {
    q: "Quelle est la différence avec la conciergerie classique à Casablanca ?",
    a: "Conciergerie : on prend une commission sur les revenus encaissés, donc votre revenu varie selon la saison. Loyer fixe : on vous verse un montant fixe identique chaque mois, peu importe le résultat. Idéal si vous avez besoin de prévisibilité (crédit, autofinancement, MRE).",
  },
  {
    q: "Pourquoi ce serait Daribnb qui prend le risque et pas moi ?",
    a: "Parce qu'on s'appuie sur plus de 7 ans d'expertise Airbnb (France & Maroc) et une connaissance fine des quartiers casablancais (Maarif, Gauthier, Racine, Anfa). On optimise mieux qu'un proprio individuel, ce qui couvre largement notre marge tout en garantissant votre revenu.",
  },
  {
  ...
  {
    q: "Tous les biens sont-ils éligibles au loyer fixe à Casablanca ?",
...
export default function LoyerFixeAirbnbCasablanca() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Loyer fixe garanti Airbnb Casablanca",
    ...
    description:
      "Daribnb verse un loyer fixe garanti chaque mois pour votre bien Airbnb à Casablanca. Revenu prévisible, zéro risque, gestion intégrale incluse.",
    url: URL,
    offers: {
      "@type": "Offer",
      priceSpecification: {
  ...
  return (
    <ServicePageLayout
      title="Loyer fixe garanti Airbnb à Casablanca | Daribnb — Revenu mensuel sans risque"
      description="Daribnb vous verse un loyer fixe garanti chaque mois pour votre bien à Casablanca. On gère tout, vous touchez un revenu prévisible. Estimation gratuite en 24h."
      canonical={URL}
      h1="Loyer fixe garanti pour votre bien à Casablanca"
      kicker="Revenu garanti · Casablanca"
      intro="Vous voulez un revenu mensuel stable sur votre bien à Casablanca, sans la variabilité du Airbnb classique ? Daribnb vous verse un loyer fixe garanti chaque mois. Nous prenons le risque commercial — vous touchez un revenu prévisible, peu importe la saison."
      ...
      <section className="py-20 md:py-28 bg-[#FAF9F6]">
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          ...
          <div className="mt-10 p-6 bg-[#1A1A1A] text-white rounded-2xl">
            <p className="text-lg">
              <strong className="text-[#C1272D]">En résumé :</strong> loyer fixe = vous voulez de la prévisibilité ; conciergerie = vous voulez maximiser le potentiel. Daribnb propose les deux à Casablanca, on vous conseille selon votre situation après audit du bien.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-[#FAF9F6]">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-10">
            Questions fréquentes sur le loyer fixe à Casablanca
          </h2>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                to: "/loyer-fixe-airbnb-rabat",
                title: "Loyer fixe Rabat",
                desc: "Le même service, disponible aussi à Rabat.",
              },
            ].map((c) => (
              <Link
                key={c.to}

...
const URL = `${SITE}/loyer-fixe-airbnb-rabat`;

const PILLARS = [
  {
    icon: Shield,
    title: "Revenu garanti chaque mois",
    desc: "Vous touchez le même montant tous les mois, peu importe le taux d'occupation. Sessions parlementaires ou creuses : aucun impact pour vous.",
  },
  {
    icon: CalendarCheck,
...
const FAQS = [
  {
    q: "Comment est calculé mon loyer fixe garanti à Rabat ?",
    a: "On audite votre bien (localisation, taille, équipement, photos), on regarde le marché local sur 12 mois (saisonnalité liée aux flux institutionnels, taux d'occupation moyen, ADR), et on vous propose un loyer fixe représentant environ 65 à 75% du revenu net potentiel. La différence couvre notre risque commercial et nos coûts opérationnels.",
  },
  {
    q: "Quelle est la différence avec la conciergerie classique à Rabat ?",
    a: "Conciergerie : on prend une commission sur les revenus encaissés, donc votre revenu varie selon la saison et les sessions institutionnelles. Loyer fixe : on vous verse un montant fixe identique chaque mois, peu importe le résultat. Idéal si vous avez besoin de prévisibilité (crédit, autofinancement, MRE).",
  },
  {
    q: "Pourquoi ce serait Daribnb qui prend le risque et pas moi ?",
    a: "Parce qu'on s'appuie sur plus de 7 ans d'expertise Airbnb (France & Maroc) et une connaissance fine des quartiers rabatis (Agdal, Hay Riad, Hassan, Souissi). On optimise mieux qu'un proprio individuel, ce qui couvre largement notre marge tout en garantissant votre revenu.",
  },
  {
    q: "Quelle est la durée d'engagement ?",
    a: "Contrat type : 12, 24 ou 36 mois. Plus c'est long, plus on peut être généreux sur le montant fixe. Préavis raisonnable de part et d'autre.",
  },
  {
    q: "Et si je veux récupérer mon bien pour des vacances ?",
    a: "Pendant le contrat de loyer fixe, le bien est en gestion totale. Pour des courts séjours perso, on peut bloquer des dates ponctuelles à condition de prévenir suffisamment à l'avance (4-6 semaines minimum) — mais c'est plus contraignant qu'en conciergerie classique.",
  },
  {
    q: "Tous les biens sont-ils éligibles au loyer fixe à Rabat ?",
    a: "Non. Le bien doit avoir un potentiel locatif suffisant (emplacement, état, équipement). Après audit, on vous dit honnêtement si le loyer fixe est viable ou si la conciergerie classique est plus adaptée à votre cas.",
  },
];

export default function LoyerFixeAirbnbRabat() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Loyer fixe garanti Airbnb Rabat",
    ...
    description:
      "Daribnb verse un loyer fixe garanti chaque mois pour votre bien Airbnb à Rabat. Revenu prévisible, zéro risque, gestion intégrale incluse.",
    url: URL,
    offers: {
      "@type": "Offer",
      priceSpecification: {
  ...
  return (
    <ServicePageLayout
      title="Loyer fixe garanti Airbnb à Rabat | Daribnb — Revenu mensuel sans risque"
      description="Daribnb vous verse un loyer fixe garanti chaque mois pour votre bien à Rabat. On gère tout, vous touchez un revenu prévisible. Estimation gratuite en 24h."
      canonical={URL}
      h1="Loyer fixe garanti pour votre bien à Rabat"
      kicker="Revenu garanti · Rabat"
      intro="Vous voulez un revenu mensuel stable sur votre bien à Rabat, sans la variabilité du Airbnb classique ? Daribnb vous verse un loyer fixe garanti chaque mois. Nous prenons le risque commercial — vous touchez un revenu prévisible, peu importe la saison."
      ...
      <section className="py-20 md:py-28 bg-[#FAF9F6]">
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          ...
          <div className="mt-10 p-6 bg-[#1A1A1A] text-white rounded-2xl">
            <p className="text-lg">
              <strong className="text-[#C1272D]">En résumé :</strong> loyer fixe = vous voulez de la prévisibilité ; conciergerie = vous voulez maximiser le potentiel. Daribnb propose les deux à Rabat, on vous conseille selon votre situation après audit du bien.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-[#FAF9F6]">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-10">
            Questions fréquentes sur le loyer fixe à Rabat
          </h2>
            ...
            {[
              {
                ...
                title: "Conciergerie Rabat",
                desc: "L'alternative : commission sur revenus, vous gardez le potentiel max.",
              },
              {
                to: "/loyer-fixe-airbnb-tanger",
                title: "Loyer fixe Tanger",
                desc: "Le même service, disponible aussi sur notre marché historique.",
              },
              {
                to: "/loyer-fixe-airbnb-casablanca",
                title: "Loyer fixe Casablanca",
                desc: "Le même service, disponible aussi à Casablanca.",
              },
            ].map((c) => (
              <Link
                key={c.to}
